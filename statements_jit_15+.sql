SELECT
    ...
    to_char(jit_deform_count::numeric       / reset_days::numeric, '999G999G990D9') AS "Deforms/Day",
    ...
    to_char((jit_deform_time                   / reset_days) * INTERVAL '1 millisecond', 'HH24:MI:SS') AS "Deform/Day",
