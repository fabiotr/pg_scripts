...
--
-- Usage:
--     psql -X [-v sql_dir=<path to sql directory>] -f report_database.sql [dbname]
--
-- If sql_dir variable is omitted use the default SQL scripts directory at $HOME/pg_scripts/sql
