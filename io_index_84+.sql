SELECT 
	...
	pg_size_pretty(trunc(current_setting('block_size')::bigint * idx_blks_hit)::bigint)  AS "Hit",
	pg_size_pretty(trunc(current_setting('block_size')::bigint * idx_blks_read)::bigint) AS "Read",
