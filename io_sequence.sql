SELECT 
	...
	relname    AS "Sequence",
	pg_size_pretty(trunc((current_setting('block_size')::bigint * blks_hit)  / reset_days)) AS "Hit/Day",
	pg_size_pretty(trunc((current_setting('block_size')::bigint * blks_read) / reset_days)) AS "Read/Day",
