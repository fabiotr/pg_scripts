...
- Cateate a new connections_running script to show memory and WAL use for each user session based on new PG 18 function pg_stat_get_backend_io() and pg_stat_get_backend_wal()
