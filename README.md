...
| Cluster  | `statements_group_database_summary.sql` | PG >= 14      | top 10 statements on all cluster order by execution time        | [`pg_stat_statements`](https://www.postgresql.org/docs/current/pgstatstatements.html) extension |
