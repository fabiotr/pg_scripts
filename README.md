...
| maintenance      | both     | `reset_all_stats.sql                    | PG >- 9.0     | Reset all stats from current database and cluster | `pg_stat_reset_*` | This script run an ANALYZE commant on current database to prevent autovacuum issues |
