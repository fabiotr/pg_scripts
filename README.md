...
| Database | `statements_resume.sql`                 | PG >= 14      | top 20 statements order by planning and execution time          | [`pg_stat_statements`](https://www.postgresql.org/docs/current/pgstatstatements.html) extension |
