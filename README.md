...
| Database | `tables_size.sql`                 | PG >= 9.5     | Top 20 tables by size                         | [`pg_table_size`](https://www.postgresql.org/docs/current/functions-admin.html#FUNCTIONS-ADMIN-DBOBJECT) |
...
| Database | `sequence_setval.sql`         |               | Generates setval commands for sequences     | [`nextval`](https://www.postgresql.org/docs/current/functions-sequence.html)                                                                   | Useful for logical replicas |
