...
lscpu | grep 'Byte Order'                                           >> /tmp/so.txt
lscpu | grep 'Vendor ID'                                            >> /tmp/so.txt
lscpu | grep 'Model name'                                           >> /tmp/so.txt
lscpu | grep 'CPU MHz'                                              >> /tmp/so.txt
lscpu | grep 'BogoMIPS'                                             >> /tmp/so.txt
lscpu | grep 'L1d'                                                  >> /tmp/so.txt
lscpu | grep 'L1i'                                                  >> /tmp/so.txt
lscpu | grep 'L2'                                                   >> /tmp/so.txt
lscpu | grep 'L3'                                                   >> /tmp/so.txt
...
for d in /sys/block/*; do
  ...
  echo "$(basename "$d"): $d/queue/scheduler"                       >> /tmp/so.txt
done
