SELECT
	...
	object,
	context,
	pg_size_pretty(trunc(read_bytes                                          / reset_days)) AS "Reads / Day",
	pg_size_pretty(trunc(write_bytes                                         / reset_days)) AS "Writes / Day",
	pg_size_pretty(trunc(writebacks * current_setting('block_size')::numeric / reset_days)) AS "Writebacks / Day",
	pg_size_pretty(trunc(extend_bytes                                        / reset_days)) AS "Extends / Day",
