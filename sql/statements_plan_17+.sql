SELECT
    ...
    to_char((total_plan_time/since_days)*100/sum((total_plan_time/since_days)) OVER (),'FM09D99') || '%' AS "load_%",
    --datname AS "DB", 
    ...
    to_char((calls::numeric/plans::numeric),         'FM999G990D9') AS "Calls/Plan",
