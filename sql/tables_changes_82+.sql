SELECT
    ...
    to_char(n_tup_ins, 'FM999G999G999G999') AS "INSERTs/Day",
    to_char(n_tup_del, 'FM999G999G999G999') AS "DELETEs/Day",
    to_char(n_tup_upd, 'FM999G999G999G999') AS "UPDATEs/Day",
    to_char((n_tup_ins + n_tup_upd + n_tup_del)            ,'FM999G999G999G999') AS "Changes",
    to_char((coalesce(n_tup_ins,0) - coalesce(n_tup_del,0)),'FM999G999G999G999') AS "New rows",
    to_char(coalesce(seq_scan,0) + coalesce(idx_scan,0)    ,'FM999G999G999G999') AS "Reads",
    CASE 
