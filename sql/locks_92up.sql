...
SELECT 
    ...
    to_char(waiting_stm.state_change ,'DD HH24:MI:SS') || ' - ' || to_char(date_trunc('second', clock_timestamp() - waiting_stm.state_change) ,'HH24:MI:SS') AS "State change",
    ...
    to_char(other_stm.state_change ,'DD HH24:MI:SS') || ' - ' || to_char(date_trunc('second', clock_timestamp() - other_stm.state_change) ,'HH24:MI:SS') AS "State change",
