SELECT 
	...
	pg_size_pretty(trunc((current_setting('block_size')::bigint * heap_blks_hit)  / reset_days)::bigint) AS "Hit/Day",
	pg_size_pretty(trunc((current_setting('block_size')::bigint * heap_blks_read) / reset_days)::bigint) AS "Read/Day",
