SELECT
    to_char(100 * checkpoints_timed::NUMERIC  / nullif((checkpoints_timed + checkpoints_req),0),'FM990D9') || ' %' AS "Checkpoints timed",
    to_char(100 * checkpoints_req::NUMERIC    / nullif((checkpoints_timed + checkpoints_req),0),'FM990D9') || ' %' AS "Checkpoints req",
    '-------' AS "------------------",
    to_char(100 * buffers_checkpoint::NUMERIC / nullif((buffers_checkpoint + buffers_clean + buffers_backend),0),'FM990D9') || ' %' AS "Written checkpoint",
