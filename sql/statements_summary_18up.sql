SELECT
    ...
    to_char((parallel_workers_to_launch::numeric/since_days::numeric), 'FM999G999G999') AS "Workers Planned/Day",
    to_char((parallel_workers_launched::numeric/since_days::numeric),  'FM999G999G999') AS "Workers Lunched/Day",
