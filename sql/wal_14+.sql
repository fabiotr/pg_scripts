SELECT
    ...
    to_char(wal_write::NUMERIC          / (EXTRACT(EPOCH FROM current_timestamp - stats_reset) / (60*60*24)),'FM999G999G990D9')          AS "Writes      / Day",
    to_char(wal_sync::NUMERIC           / (EXTRACT(EPOCH FROM current_timestamp - stats_reset) / (60*60*24)),'FM999G999G990D9')          AS "Syncs       / Day",
