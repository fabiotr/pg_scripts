SELECT
    ...
    trim(to_char((sum(parallel_workers_to_launch)/reset_days::numeric), '999G999G999')) || ' - ' ||
    trim(to_char((sum(parallel_workers_launched)/reset_days::numeric),  '999G999G999')) AS "Workers (Planned - Lunched)/Day",
