SELECT
  ...
  reltuples - tuples_excluded                                                                 AS "Rows Total",
  tuples_skipped                                                                              AS "Rows Skipped",
  trunc((tuples_skipped::numeric   * 100) / nullif(reltuples - tuples_excluded,0)::numeric,1) AS "% Rows Skipped",
